// pages/CommunityCategories/index.js
...
const CommunityCategories = () => {
  ...
  const handleEditCategory = async (values) => {
    ...
    try {
      const response = await axios.post(
        `${base_url}/admin/blogs/edit_blog_category.php`,
        {
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm m-0">
                        Manage your community categories
                      </p>
                    </div>
                  </div>
                  <Button
      ...
      <Modal
        title={
          <div className="flex items-center gap-2">
            ...
            <span>Add New Community Category</span>
          </div>
        }
      ...
      <Modal
        title={
          <div className="flex items-center gap-2">
            ...
            <span>Edit Community Category</span>
          </div>
        }
