// src/components/Transfer/TransferFeatures.jsx
import React, { useEffect } from "react";
import { RiDeleteBin6Line } from "react-icons/ri";
import IconSelector from "../IconFeatures/IconSelector";

const TransferFeatures = ({ rowData, setRowData }) => {
  // ✅ Get features array - check both featuresArray and features
  ...
  const convertFeaturesToString = (features) => {
    ...
    return features
      .filter((f) => f.name || f.label) // Only include items with name/label
      .map((f) => {
  ...
  useEffect(() => {
    ...
    console.log("features string:", convertFeaturesToString(featuresArray));
  }, [featuresArray]);
  ...
  const handleFeatureChange = (index, field, value) => {
    ...
    setRowData((prev) => ({
      ...
      featuresString: featuresString, // ✅ Store formatted string separately
    }));
  };
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="e.g., Free GPS, Air Conditioning..."
                />
              </div>
