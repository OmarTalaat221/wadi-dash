...
function ImportToursExcel({ open, setOpen }) {
  ...
  return open ? (
    ...
    >
      <div
        ...
        className={`import-tour-excel min-h-[270px] py-3 flex justify-center items-center border-dashed border-3 w-[96%] m-auto flex-col gap-2 ${
      ...
      >
        ...
        <input
          ...
          type="file"
          name="import-tour-excel"
          id="import-tour-excel"
          className="hidden"
        />
      </div>
    </Modal>
...
export default ImportToursExcel;
